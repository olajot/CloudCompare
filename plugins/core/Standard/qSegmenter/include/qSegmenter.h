...
//! Example qCC plugin
/** Replace 'qSegmenter' by your own plugin class name throughout and then
	check 'qSegmenter.cpp' for more directions.
...
**/
class qSegmenter : public QObject, public ccStdPluginInterface
{
	Q_OBJECT
	...
	Q_PLUGIN_METADATA( IID "cccorp.cloudcompare.plugin.qSegmenter" FILE "../info.json" )

public:
	explicit qSegmenter( QObject *parent = nullptr );
	~qSegmenter() override = default;
